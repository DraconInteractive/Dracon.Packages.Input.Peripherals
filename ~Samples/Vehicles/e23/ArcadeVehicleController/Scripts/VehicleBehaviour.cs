...
namespace e23.VehicleController
{
    public class VehicleBehaviour : MonoBehaviour
    {
        ...
        public void SetVehicleSettings()
        {
            ...
            rayMaxDistance = Vector3.Distance(transform.position, VehicleModel.position) + 0.05f; // add 0.05f extra to the distance to account for vehicle tilt
            SetAngularDrag();
        }
        ...
        public void Jump(float force, ForceMode forceMode = ForceMode.Impulse)
        {
            PhysicsSphere.AddForce(Vector3.up * force, forceMode);
        }
